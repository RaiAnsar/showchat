...
badd +20 server_code.js
badd +49 source_js/controllers.js
badd +1 source_js/script.js
badd +19 ~/.vimrc
badd +5 temp
badd +6 ~/.tmux.conf
badd +1 public/search.html
badd +1 public/postlist.html
badd +1 source_js/postlist.js
badd +1 connection.js
badd +1 source_js/connection.js
badd +14 source_js/theaterSearch.js
badd +1 source_js/search.js
badd +1 source_js/theater.js
badd +5 out
badd +1 source_js/twitter.js
badd +0 public/theater.html
...
silent! normal! zE
let s:l = 90 - ((21 * winheight(0) + 16) / 33)
...
normal! 030|
lcd ~/showchat
tabedit ~/showchat/public/search.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 04|
lcd ~/showchat
tabedit ~/showchat/public/postlist.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 50 - ((25 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
50
normal! 029|
lcd ~/showchat
tabedit ~/showchat/source_js/postlist.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 57 - ((15 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
normal! 05|
lcd ~/showchat
tabedit ~/showchat/source_js/controllers.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 35 - ((0 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
...
exe 'vert 1resize ' . ((&columns * 135 + 135) / 270)
exe 'vert 2resize ' . ((&columns * 134 + 135) / 270)
tabedit ~/showchat/source_js/theater.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 0
lcd ~/showchat
tabedit ~/showchat/public/theater.html
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 35 - ((28 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
normal! 0
lcd ~/showchat
tabedit ~/showchat/server_code.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 40 - ((9 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
normal! 0
lcd ~/showchat
tabedit ~/showchat/source_js/search.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 036|
lcd ~/showchat
tabedit ~/showchat/source_js/connection.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
normal! 0
lcd ~/showchat
tabedit ~/showchat/source_js/twitter.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 46 - ((30 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
